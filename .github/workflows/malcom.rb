...
#Use macros to abstract away the explicity defined setter and getter methods in a Ruby class
#What is macro?
...
def name=(full_name)
first_name, last_name = full_name.splits
@first_name = first_name
@last_name = last_name
